...
{
    public class KodelisteValidatorV3 : EntityValidatorBase, IKodelisteValidator
    {
        ...
        public KodelisteValidatorV3(IList<EntityValidatorNode> entityValidatorTree, int? nodeId, object codeListName, RegistryType registryType, ICodeListService codeListService)
