...
namespace Dibk.Ftpb.Validation.Application.Logic.EntityValidators
{
    public class EnkelAdresseValidator : EntityValidatorBase, IEnkelAdresseValidator
    {
        ...
        protected override void InitializeValidationRules()
        {
            ...
            AddValidationRule(ValidationRuleEnum.postnr_stemmerIkke, FieldNameEnum.poststed, $"{_entityXPath}.{FieldNameEnum.postnr}");
                            ...
                            else
                            {
                                ...
                                if (postnrValidation != null)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        {
                                            AddMessageFromRule(ValidationRuleEnum.postnr_stemmerIkke, FieldNameEnum.poststed, new[] { postNr, enkelAdresse.Poststed, postnrValidation.Result });
                                        }
                                    }
                                }
                                else
